/**
 * The Interviewing Earl — question set and flow control. Copied from the Bridge
 * (server/data/intake-questions.js).
 *
...
export const STAGE_COMPLETE = {
  1: `That is enough to get started. Earl has what he needs to begin. Whenever you want to go deeper, Stage 2 is waiting here.`,
  2: `Earl now has the operational context he needs to give you specific direction, and your goals are ready to review. Stage 3 is the most personal stage and the most important one. Take it when you are ready.`,
  3: `That is everything. Earl now has the full picture. Go have a real conversation.`
};
...
export const QUESTIONS = [
  ...
  { n: 8, stage: 1, field: 'desired_outcome',
    question: 'What do you most want from Earl? What would make this worth your time?',
...
export function getQuestionByField(field) {
  return QUESTIONS.find(q => q.field === field) || null;
}

export function getQuestionByNumber(n) {
