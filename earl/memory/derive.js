// derive.js — ported from the Bridge. Turns a finished session into structured
// memory (facts with supersession, decisions, deflections) and rewrites the
// member's profile document. The only LLM calls in the memory system.

import Anthropic from "@anthropic-ai/sdk";
import { getSessionMessages as getCommanderSessionMessages } from "../db.js";
 ...
 */
export async function deriveSession(userId, sessionId, opts = {}) {
