// Server-side financial data. This lives behind the passcode (served only via the
// gated /api/finance endpoint) so the numbers are never in the public app code.
// Seed data for now; gets replaced by live pulls (bank/AirVend/COGS) later.
